...
class ListCombinationTask extends Component {
    constructor(props) {
        super(props);
        this.state = {
            userId: 0,
    ...
    fetchData = async () => {
        ...
        const url = `${API_URL}/api/HscvCongViec/CombinationWork/${this.state.userId}/${this.state.pageSize}/${this.state.pageIndex}?query=`;
...
export default connect(mapStatetoProps)(ListCombinationTask);