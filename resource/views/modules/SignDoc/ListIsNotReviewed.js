...
class ListIsNotReviewed extends Component {
    constructor(props) {
        super(props);
        this.state = {
            userId: 0,
    ...
    fetchData = async () => {
        ...
        const url = `${API_URL}/api/VanBanDi/GetListReview/${this.state.userId}/${this.state.pageSize}/${this.state.pageIndex}?query=`;
...
export default connect(mapStateToProps)(ListIsNotReviewed);