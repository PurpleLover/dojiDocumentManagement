...
import {
    ...
    FlatList, TouchableOpacity, Image, Toast
} from 'react-native';
...
class ListIsProcessed extends Component {
    constructor(props) {
        super(props);
        this.state = {
            userId: 0,
...
export default connect(mapStateToProps)(ListIsProcessed);