...
class ListIsNotProcessed extends Component {
    ...
    fetchData = async () => {
        ...
        const url = `${API_URL}/api/VanBanDi/GetListProcessing/${this.state.userId}/${this.state.pageSize}/${this.state.pageIndex}?query=`;
...
export default connect(mapStatetoProps)(ListIsNotProcessed);